...
import EscalatorList from "./Components/Escalators/EscalatorList";
import ContactList from "./Components/Escalators/ContactList";
import ZoneWiseWiseReport from "./Components/Escalators/Reports";
            ...
            <Routes>
				...
				*/}
                ...
                >
                    ...
                    <Route path="dashboard" element={<EscalatorList />} />
                    <Route path="*" element={<EscalatorList />} />
                    <Route path="setting" element={<ContactList/>}/>
                    <Route path="reports" element={<ZoneWiseWiseReport/>}/>
                </Route>
